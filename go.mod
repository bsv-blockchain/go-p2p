...
require (
	github.com/bitcoin-sv/alert-system v0.1.15
...
require (
	...
	github.com/bsv-blockchain/go-bn v1.0.3 // indirect
	github.com/bsv-blockchain/go-bt/v2 v2.4.5 // indirect
	github.com/bsv-blockchain/go-sdk v1.2.6 // indirect
