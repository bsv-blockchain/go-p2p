...
const (
	// Version is the initial handshake message type sent by a peer to announce its capabilities and blockchain state.
	Version MessageType = "version"
	// Verack is the acknowledgment message type sent by a peer to confirm receipt of a version message.
